...
export const readCollectionByUsername: RequestHandler = async (req: Request, res: Response) => {
    try {
        ...
        console.log(`[COLLECTION][readCollectionByUsername] Fetching collection for user ID: ${targetUserId}, isOwner: ${isOwner}, hasOAuth: ${hasOAuth}`);
...
export const readWantlistByUsername: RequestHandler = async (req: Request, res: Response) => {
    try {
        ...
        console.log(`[WANTLIST][readWantlistByUsername] Fetching wantlist for user ID: ${targetUserId}, isOwner: ${isOwner}, hasOAuth: ${hasOAuth}`);
